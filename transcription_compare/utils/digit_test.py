...
class TestCerFirst(unittest.TestCase):
    ...
    def test_2nd(self):
        """
        """
        result = our_is_digit('0')
        self.assertEqual(result, [{'oh', 'zero', 'zeroth'}])

    def test_3(self):
        """
        """
        result = our_is_digit('101')
    ...
    def test_10(self):
        """
        """
        result = our_is_digit('h2o')
        self.assertEqual(result, [{'h'}, {'second', 'two'}, {'o'}])

    def test_11(self):
        """
        """
        result = our_is_digit('m370')
